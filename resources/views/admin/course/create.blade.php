              ...
              <div class="border-b border-white/10 pb-12">
                ...
                <div class="mt-10 grid gap-y-8 sm:grid-cols-3">
                  ...
                  <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                      <input type="date" id="date" name="date" class="block w-full rounded-md border-0 bg-white/5 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6">
                    </div>
                  </div>

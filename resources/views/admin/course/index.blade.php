                          ...
                          <table class="min-w-full divide-y divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-800">
                              @foreach ($courses as $course)
                                  <tr>
                                      <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-white sm:pl-0">{{ $course->name }}</td>
                                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-300">{{ date('d.m.Y', strtotime($course->date)) }}</td>
                                      <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                          <a href="{{url('admin/courses/' . $course->id)}}" class="text-indigo-400 hover:text-indigo-300">View</a>
                                      </td>
                                      <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                        <a href="{{route('courses.edit', $course->id)}}" class="text-indigo-400 hover:text-indigo-300">Edit</a>
                                      </td>
                                      <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
